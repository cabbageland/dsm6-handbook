  ...
  scoreResult.innerHTML = `
    <div class="score-reading">
      ...
      <div>
        ...
        <p>${result.style}</p>
        <p>Secondary findings suggest a person of high sensitivity, decent taste, and insufficient insulation from modern nonsense. You are not uniquely doomed, but you are making several completely avoidable choices with unsettling consistency.</p>
      </div>
      <div>
