...
const archetypes = [
  ...
  { title: 'Main-Character Logistics Fatigue', blurb: 'You are carrying yourself like a protagonist while being repeatedly humbled by passwords, errands, tabs, chargers, forms, and the beige cruelty of administrative life.', style: 'The plot is not defeating you. Admin is, which is somehow funnier and more insulting. You keep preparing for meaningful arcs while being ambushed by account recovery flows and grocery errands with eight subclauses. This is not beneath you. This is simply the current genre, and it is rude.', treatment: 'Prescribe one heroic but extremely boring admin hour, followed by something beautiful enough to remind you that your life is not actually a spreadsheet with skin.' },
